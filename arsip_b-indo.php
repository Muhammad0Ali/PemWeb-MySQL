...
<head>
	<meta charset="utf-8" />
	<title>	Basic | Arsip Bahasa Indonesia </title>
...
echo "<small>Berita dikirimkan oleh <b>$pengirim</b>
       ...
       <b>$kategori</b><br>";
echo "<br/>";
echo "<b>Action : </b><a class=listarsip href='edit_materi.php?id=$id_berita'>Edit</a> | ";
echo "<a class=listarsip href='delete_materi.php?id=$id_berita'
